...
#define HYLRecordFielName @"HYLRecord.caf"

@interface HYLRecordKit ()<AVAudioRecorderDelegate>
...
- (AVAudioRecorder *)recorder {
    ...
    if (!_recorder) {
        ...
        NSString *filePath = [path stringByAppendingPathComponent:HYLRecordFielName];
...
- (void)updateImage {
    ...
    if ([self.delegate respondsToSelector:@selector(recordKit:didstartRecording:)]) {
        [self.delegate recordKit:self didstartRecording:level];
    }
}
